...
# PDF view sample
The **DirectN.Samples.PdfView** sample here [https://github.com/smourier/DirectNAot/tree/main/Samples/DirectN.Samples.PdfView](https://github.com/smourier/DirectNAot/tree/main/Samples/DirectN.Samples.PdfView) is a fully non-Winforms, non-WPF, non-WinUI3 window GUI app that can display a PDF file's content.
